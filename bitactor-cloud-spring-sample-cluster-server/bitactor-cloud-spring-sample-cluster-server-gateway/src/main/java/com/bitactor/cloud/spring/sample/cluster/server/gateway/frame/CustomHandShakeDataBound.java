...
public class CustomHandShakeDataBound implements HandShakeDataBound {
    public void buildCustomHandShakeData(HandShakeData handShakeData, UrlProperties url) {
        handShakeData.addCustomParameter(GroupType.GATEWAY, GroupType.GATEWAY);
        handShakeData.addCustomParameter(GroupType.WORLD, GroupType.WORLD);
        handShakeData.addCustomParameter(GroupType.AUTH, GroupType.AUTH);
    }
